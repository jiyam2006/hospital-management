    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0" method="post" action="search.php">
                <input class="form-control mr-sm-2" type="text" placeholder="Enter name or contact" aria-label="Search"
                    name="fname">
...
<body style="padding-top:50px;">
    <div class="container-fluid" style="margin-top:50px;">
        <h3 style="margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome
            Dr.&nbsp<?php echo $_SESSION['dname'] ?> </h3>
        <div class="row">
                    ...
                    <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $query = "select pid,fname,lname,ID,appdate,apptime,drugname,route,frequencytime,quantity,price from prestb where doctor='$doctor' ORDER BY ID DESC;";
                    ...
                    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-pat-list">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $query = "select * from appointmenttb ORDER BY pid DESC;";
                                $result = mysqli_query($con, $query);
                                while ($row = mysqli_fetch_array($result)) {
