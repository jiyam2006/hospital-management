...
$pid = $_SESSION['pid'];
echo "<script>console.log('PID in session: $pid');</script>";
                                        ...
                                        <div class="row">
                                            ...
                                            document.getElementById('doctor').onchange = function updateFees(e) {
                                                ...
                                                let selectedOption = document.querySelector(
                                                    `#doctor option[value='${selectedDoctor}']`);

                                                if (selectedOption) {
                                                    let fee = selectedOption.getAttribute('data-value');
                                                    console.log("Selected Doctor:", selectedDoctor);
                                                    console.log("Doctor Fee Found:", fee);
                                                    document.getElementById('docFees').value = fee;
                                                } else {
                                                    console.log("No doctor fee found!");
                    ...
                    <div class="tab-pane fade" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $query = "select doctor,ID,appdate,apptime,drugname,route,frequencytime,quantity,price from prestb where pid='$pid' ORDER BY ID DESC;";
                              ...
                              title="Pay Bill" tooltip-placement="top" tooltip="Remove"><button class="btn btn-success">Pay</button>
                                        ...
                                        <a href="pay/index.php?ID=<?php echo $row['ID']; ?>" class="btn btn-success">Pay
                                            Bill</a>
